...
#define DIST_UNIV_SCHED_VARY_BITS_CREATE_PACKET_DEBUG 0
#define DIST_UNIV_SCHED_VARY_BITS_UNPACK_PACKET_DEBUG 0
#define DIST_UNIV_SCHED_EXCHANGE_GLOBAL_INFO_DEBUG 0
#define DIST_UNIV_SCHED_LINE_NET_DEBUG 0
#define DIST_UNIV_SCHED_BRUTE_FORCE_DEBUG 0
#define DIST_UNIV_SCHED_USE_DELAYED_INFO_DEBUG 0
#define DIST_UNIV_SCHED_VARY_NUM_EXCHANGE_ROUNDS_DEBUG 0
#define DIST_UNIV_SCHED_EXCHANGE_BRUTE_FORCE_INFO_DEBUG 0
#define DIST_UNIV_SCHED_EXCHANGE_USE_DELAYED_INFO_DEBUG 0
...
#define DIST_UNIV_SCHED_DISCRETE_Q_VALUE_DEBUG 0
#define DIST_UNIV_SCHED_CLASSIFY_TIME_SLOT_DEBUG 0
#define DIST_UNIV_SCHED_MAKE_GLOBAL_DECISION_DEBUG 0
#define CONNECTIVITY_DEBUG 0
