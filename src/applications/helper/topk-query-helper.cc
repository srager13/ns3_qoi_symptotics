...
TopkQueryClientHelper::TopkQueryClientHelper (Address address, uint16_t port)
{
...
TopkQueryClientHelper::TopkQueryClientHelper (Ipv4Address address, uint16_t port)
{
  m_factory.SetTypeId (TopkQueryClient::GetTypeId ());
...
TopkQueryClientHelper::TopkQueryClientHelper (Ipv6Address address, uint16_t port)
{
  m_factory.SetTypeId (TopkQueryClient::GetTypeId ());
  SetAttribute ("RemoteAddress", AddressValue (Address(address)));
  SetAttribute ("RemotePort", UintegerValue (port));
